...
<html>
	...
	<body>
		...
		<nav class="verticalNav">
			<ul>
				<li><span class="glyphicon glyphicon-search"></span>ressources materiels</li>
				<hr/>
				<li><span class="glyphicon glyphicon-plus-sign"></span>ajouter</li>
				<hr/>
				<li><span class="glyphicon glyphicon-pencil"></span>modifier</li>
				<hr/>
				<li><span class="glyphicon glyphicon-trash"></span>suprimer</li>
				<hr/>
			</ul>
		</nav>
		<section >
